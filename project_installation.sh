...
7za e $DOWNLOAD_PATH$"Posts.xml.7z"
rm $DOWNLOAD_PATH$"Posts.xml.7z"
7za e $DOWNLOAD_PATH$"PostReferenceGH.csv.7z"
rm $DOWNLOAD_PATH$"PostReferenceGH.csv.7z"
7za e $DOWNLOAD_PATH$"PostLinks.xml.7z"
rm $DOWNLOAD_PATH$"PostLinks.xml.7z"
7za e $DOWNLOAD_PATH$"Comments.xml.7z"
rm $DOWNLOAD_PATH$"Comments.xml.7z"
...
LOAD XML LOCAL INFILE $DOWNLOAD_PATH$'Comments.xml' INTO TABLE Comments ROWS IDENTIFIED BY '<row>';
LOAD XML LOCAL INFILE $DOWNLOAD_PATH$'Posts.xml' INTO TABLE Posts ROWS IDENTIFIED BY '<row>';
LOAD XML LOCAL INFILE $DOWNLOAD_PATH$'PostLinks.xml' INTO TABLE PostLinks ROWS IDENTIFIED BY '<row>';
LOAD DATA LOCAL INFILE $DOWNLOAD_PATH$'PostReferenceGH.csv' INTO TABLE PostReferenceGH FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 ROWS (FileId, Repo, RepoOwner, RepoName, Branch, Path, FileExt, Size, Copies, PostId, @CommentId, SOUrl, GHUrl) SET CommentId = nullif(@CommentId, '');
...
LOAD DATA LOCAL INFILE 'answers.csv' INTO TABLE Answers FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';
LOAD DATA LOCAL INFILE 'comments.csv' INTO TABLE Comments FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';
LOAD DATA LOCAL INFILE 'postlinks.csv' INTO TABLE PostLinks FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';
LOAD DATA LOCAL INFILE 'postreferGH.csv' INTO TABLE PostReferenceGH FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';
